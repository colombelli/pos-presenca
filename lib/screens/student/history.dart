                  ...
                  children: <Widget>[
                    Card(
                      child: CalendarCarousel(
                        ...
                        weekFormat: false,
                        height: 350.0,
                        markedDateWidget: Positioned(child: Container(color: Colors.orange[700], height: 4.0, width: 4.0), bottom: 4.0, left: 18.0),
                        markedDateIconMaxShown: 1,
                        showHeader: true,
                        headerTextStyle: TextStyle(color: Colors.orange[700]),
                        daysHaveCircularBorder: true,
                        iconColor: Colors.orange[700],
                        locale: 'pt',
                        selectedDayButtonColor: Colors.orange[500], 
